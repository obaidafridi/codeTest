...
class BookingRepository extends BaseRepository
{
    ...
    public function getUsersJobs($user_id)
    {
        ...
        if ($cuser && in_array($cuser->role, ['customer', 'translator'])) {
            ...
            if ($cuser->is('customer')) {
                ...
                $jobs = $cuser->translatorJobs()->with([
                    'user.userMeta',
                    'user.average',
                    'translatorJobRel.user.average',
                    'language',
                    'feedback'
                ])->where('status', 'new')->get()->pluck('jobs')->all();
                $usertype = 'translator';
            }
            ...
            $normalJobs = collect($jobs)->filter(function ($jobitem) {
                return $jobitem->immediate != 'yes';
    ...
    public function storeJobEmail($data)
    {
        ...
        $this->setJobDetailsFromData($job, $user, $data);
    ...
    private function setJobDetailsFromData(Job $job, User $user, array $data): void
    {
